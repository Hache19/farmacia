                    ...
                    <form action="{{route('lote.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="date" id="vencimiento" name="vencimiento"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="vencimiento" value=" {{old('vencimiento')}} ">
                        </div>
                        @error('vencimiento')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
                        ...
                        <div class="mb-6">
                            <label for="precio_compra" class="text-sm font-medium text-gray-900 block mb-2">
                                precio_compra:</label>
                            <input type="number" id="precio_compra" name="precio_compra"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="precio_compra " value=" {{old('precio_compra')}} ">
                        </div>
                        @error('precio_compra')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
