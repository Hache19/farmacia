                    ...
                    <form action="{{route('producto.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="nombre_producto" name="nombre_producto"
                                ...
                                placeholder="Nombre producto" value=" {{old('nombre_producto')}} ">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="descripcion" name="descripcion"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Apellido" value=" {{old('apellido_personal')}} ">
                        </div>
                        @error('descripcion')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" id="precio" name="precio"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="precio venta" value=" {{old('precio_venta')}} ">
                        </div>
                        @error('precio')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
                        ...
                        <label for="idpresentacion" class="inline-block w-20 mr-6 text-right font-bold text-gray-600">
                            IdPresentacion:
                        </label>
                        ...
                        <label for="idtipoproducto" class="inline-block w-20 mr-6 text-right font-bold text-gray-600">
                            Idtipo_producto:
                        </label>
                        <div class="flex items-center mb-5">
                        ...
                        <label for="idlaboratorio" class="inline-block w-20 mr-6 text-right font-bold text-gray-600">
                            IdLaboratorio:
                        </label>
                        <div class="flex items-center mb-5">
