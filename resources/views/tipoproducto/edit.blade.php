            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('tipoproducto.update', $tipoproducto)}}" method="POST">
                        @csrf @method('PUT')
                        <div class="mb-6">
                            <label for="nombre_tipo" class="text-sm font-medium text-gray-900 block mb-2">
                                Nombre Tipo Producto:</label>
                            <input value=" {{old('nombre_tipo', $tipoproducto->nombre_tipo)}} " type="text" id="nombre_tipo" name="nombre_tipo" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
