                    ...
                    <form action="{{route('cliente.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="nombre_cliente" name="nombre_cliente"
                                ...
                                placeholder="Ingrese el nombre cliente" value=" {{old('nombre_cliente')}} ">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="apellido_cliente" name="apellido_cliente"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Ingrese el apellido cliente" value=" {{old('apellido_cliente')}} ">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="ci" name="ci"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Ingrese el C.I." value=" {{old('ci')}} ">
                        </div>
                        @error('ci')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="direccion" name="direccion"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Ingrese el Direccion" value=" {{old('direccion')}} ">
                        </div>
                        @error('direccion')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
