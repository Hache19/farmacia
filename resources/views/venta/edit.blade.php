                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('rol.update', $rol)}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('nombre_rol', $rol->nombre_rol)}} " type="text" id="nombre_rol" name="nombre_rol" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>
