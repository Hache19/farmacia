                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('personal.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="apellido_personal" name="apellido_personal"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        ...
                        <div class="mb-6">
                            <label for="fecha_nac" class="text-sm font-medium text-gray-900 block mb-2">Fecha Nacimiento:</label>
                            <input type="date" id="fecha_nac" name="fecha_nac"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="fecha nac" value=" {{old('fecha_nac')}} ">
                        </div>
                        @error('fecha_nac')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
                        ...
                        <label for="idrol" class="inline-block w-20 mr-6 text-right font-bold text-gray-600">
                            IdRol:
                        </label>
