        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('presentacion.update', $presentacion)}}" method="POST">
                        @csrf @method('PUT')
                        <div class="mb-6">
                            <label for="nombre_presentacion" class="text-sm font-medium text-gray-900 block mb-2">Nombre Presentacion:</label>
